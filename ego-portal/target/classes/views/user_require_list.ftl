...
<script type="template" id="shopInfoTemplate">
    ...
    <div class="detail_product">
        ...
        <img src="${ctx}/static/images/user_want.png" height="196px" style="width: 186px;height: 156px"><br>
        ...
        <div class="delete_and_update">
            <a href="${ctx}/userwant/updateview?id={{=it[i].id}}"><img src="${ctx}/static/img/pencil.jpg" class="update_publish"></a>
